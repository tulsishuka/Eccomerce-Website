...
//                 className="absolute right-0 bottom-3 text-xs text-gray-400 hover:text-black transition-colors"
//               >
...
//                 className="text-xs leading-relaxed text-gray-600 font-light cursor-pointer"
//               >
//                 Sign me up for the Aura Luxe newsletter to receive early access
//                 to new arrivals and exclusive editorial content.
//               </label>
//             </div>
...
//             <button
//               type="submit"
//               className="w-full bg-black text-white py-4 mt-4 text-[11px] tracking-[0.2em] uppercase font-semibold hover:bg-zinc-800 transition-colors"
//             >
//               Register
//             </button>
//           </form>
